...
ספר הכוזרי | שער האמונה | תורה ומדע (2 vol.) | תכלית החיים | מיהו בן חורין אמיתי | אורות של אמת | אור חוזר | הכוח השלישי | מחפשים את האמת | שכרן של מצוות | סוד השבת - אור הנשמה | העיתונאי (6 vol.) | מי נגד מי - דת שיח חרדי-חילוני | אמונה והשגחה מספר איוב | דוד המלך ועוצמת התהלים | ימי הילולא דצדיקיא | ספר מעשי אבות | סדר הדורות המקוצר | ספר קבלת חכמי מרוקו | פרקי דרבי אליעזר | סיפורי ניסים | תכתב זאת לדור אחרון | אגלך לשמים | פירוש אור אח על פתח אליהו | דרך מנוחה - פירוש לאגרת הרמב"ן | מפתח ענייני התנ"ך | פסיכולוגיה הגון | אחות יקרה | איגרת כבת ישראל הייקרה | המשתתמים
